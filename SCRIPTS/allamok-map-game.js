...
function generateCountryList() {
    ...
    for (let i = 0; i < countries.length; i++) {
        ...
        nameEl.textContent = country.name.trim().toUpperCase();
...
function handleSubmit() {
    ...
    for (let i = 0; i < countries.length; i++) {
        ...
        resultEl.textContent = "Összesen " + correctAnswers + " helyes válaszod volt " + totalAnswers + " államból.";
    }
